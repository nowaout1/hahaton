...
const ROLE_COPY: Record<Role, { badge: string; title: string; subtitle: string }> = {
  user: {
    ...
    subtitle: "Отмечайте смены, выходные и отпуск, быстро пересчитывайте итог и отправляйте график не отвлекаясь от работы.",
  },
  manager: {
    badge: "Контроль команды",
    title: "Панель менеджера",
    subtitle: "Следите за заполнением графиков, выбирайте сотрудников и экспортируйте данные в Excel.",
  },
  admin: {
    badge: "Root access",
    title: "Управление персоналом",
    subtitle: "Роли, верификация, альянсы и состав команды в одном рабочем контуре.",
  },
};
